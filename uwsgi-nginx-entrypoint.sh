...
if [ -f /app/nginx.conf ]; then
    ...
    content=$content'    log_format  main  "ConnectionTime $connection_time ConnectionsActive $connections_active Hostname $hostname RemoteAddress $remote_addr StatusCode $status UpstreamAddress $upstream_addr Uri $uri method $request_method";\n'
